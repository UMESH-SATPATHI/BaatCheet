...
export default function ChatsSidebar({ onOpenNewChat }) {
  ...
  return (
    <aside className="w-[340px] h-full bg-[#17171c] border-r border-[#22222b] flex flex-col select-none shrink-0 z-10">
      {/* Header */}
      <div className="px-5 pt-4 pb-2 flex flex-col">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 relative">
            <button
              ...
              title="New Chat"
              className="w-8 h-8 rounded-xl bg-[#8b5cf6] hover:bg-[#7c3aed] text-white flex items-center justify-center shadow-md shadow-purple-900/30 transition cursor-pointer"
            >
        ...
        {/* Search Bar */}
        <div className="mt-3.5 bg-[#24242c] rounded-4xl flex items-center px-3.5 py-2.5 gap-2.5 border border-transparent focus-within:border-[#8b5cf6]/50 transition">
          ...
          <button
            ...
            className={`text-xs font-semibold px-4 py-1.5 rounded-full transition cursor-pointer ${
              activeFilter === "all"
                ...
                : "bg-[#24242c] text-zinc-400 hover:text-zinc-200"
            }`}
          >
            All
          </button>
            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 px-3 py-3 rounded-2xl cursor-pointer transition-all ${
                  isSelected
                    ? "bg-[#241c33] border border-[#8b5cf6]/30 shadow-sm"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-2 mt-1">
                    <p className="text-xs text-zinc-400 truncate flex-1 leading-snug">
